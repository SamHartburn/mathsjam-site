...
extra_text: We're currently on a break due to work committments and will restart in September. Meetings will be confirmed by email - please let us know if you're planning to come so that we can include
    you in the email.
links:
    twitter:
        text: '@CANMathsJam'
